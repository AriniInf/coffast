...
<head>
    ...
    <!-- Favicons -->
    <link href="../assets/frontoffice/img/favicon.png" rel="icon">
    <link href="../assets/frontoffice/img/apple-touch-icon.png" rel="apple-touch-icon">

    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Poppins:300,300i,400,400i,600,600i,700,700i|Satisfy|Comic+Neue:300,300i,400,400i,700,700i" rel="stylesheet">

    <!-- Vendor CSS Files -->
    <link href="../assets/frontoffice/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="../assets/frontoffice/vendor/icofont/icofont.min.css" rel="stylesheet">
    <link href="../assets/frontoffice/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
    <link href="../assets/frontoffice/vendor/animate.css/animate.min.css" rel="stylesheet">
    <link href="../assets/frontoffice/vendor/venobox/venobox.css" rel="stylesheet">
    <link href="../assets/frontoffice/vendor/owl.carousel/assets/owl.carousel.min.css" rel="stylesheet">
...
<body>
        ...
        <div class="hero-container">
            <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <!-- Slide 3 -->
                    <div class="carousel-item" style="background: url(../assets/frontoffice/img/slide/slide-3.jpg);">
                        <div class="carousel-background"><img src="../assets/frontoffice/img/slide/slide-3.jpg" alt=""></div>
                        <div class="carousel-container">
                            <div class="carousel-content">
        ...
        <section id="events" class="events">
            <div class="container">
                ...
                <div class="owl-carousel events-carousel">
                    ...
                    <div class="row event-item">
                        <div class="col-lg-6">
                            <img src="../assets/frontoffice/img/event-private.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="col-lg-6 pt-4 pt-lg-0 content">
                    ...
                    <div class="row event-item">
                        <div class="col-lg-6">
                            <img src="../assets/frontoffice/img/event-custom.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="col-lg-6 pt-4 pt-lg-0 content">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="../assets/frontoffice/img/gallery/gallery-1.jpg" class="venobox" data-gall="gallery-item">
                                <img src="../assets/frontoffice/img/gallery/gallery-1.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="../assets/frontoffice/img/gallery/gallery-2.jpg" class="venobox" data-gall="gallery-item">
                                <img src="../assets/frontoffice/img/gallery/gallery-2.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="../assets/frontoffice/img/gallery/gallery-3.jpg" class="venobox" data-gall="gallery-item">
                                <img src="../assets/frontoffice/img/gallery/gallery-3.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="../assets/frontoffice/img/gallery/gallery-4.jpg" class="venobox" data-gall="gallery-item">
                                <img src="../assets/frontoffice/img/gallery/gallery-4.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="../assets/frontoffice/img/gallery/gallery-5.jpg" class="venobox" data-gall="gallery-item">
                                <img src="../assets/frontoffice/img/gallery/gallery-5.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="../assets/frontoffice/img/gallery/gallery-6.jpg" class="venobox" data-gall="gallery-item">
                                <img src="../assets/frontoffice/img/gallery/gallery-6.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="../assets/frontoffice/img/gallery/gallery-7.jpg" class="venobox" data-gall="gallery-item">
                                <img src="../assets/frontoffice/img/gallery/gallery-7.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="../assets/frontoffice/img/gallery/gallery-8.jpg" class="venobox" data-gall="gallery-item">
                                <img src="../assets/frontoffice/img/gallery/gallery-8.jpg" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="member">
                            <div class="pic"><img src="../assets/frontoffice/img/chefs/chefs-1.jpg" class="img-fluid" alt=""></div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="member">
                            <div class="pic"><img src="../assets/frontoffice/img/chefs/chefs-2.jpg" class="img-fluid" alt=""></div>
                            <div class="member-info">
                                <h4>Sarah Jhonson</h4>
                                <span>Patissier</span>
                                <div class="social">
    ...
    <!-- Vendor JS Files -->
    <script src="../assets/frontoffice/vendor/jquery/jquery.min.js"></script>
    <script src="../assets/frontoffice/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="../assets/frontoffice/vendor/jquery.easing/jquery.easing.min.js"></script>
    <script src="../assets/frontoffice/vendor/php-email-form/validate.js"></script>
    <script src="../assets/frontoffice/vendor/jquery-sticky/jquery.sticky.js"></script>
    <script src="../assets/frontoffice/vendor/isotope-layout/isotope.pkgd.min.js"></script>
    <script src="../assets/frontoffice/vendor/venobox/venobox.min.js"></script>
    <script src="../assets/frontoffice/vendor/owl.carousel/owl.carousel.min.js"></script>
