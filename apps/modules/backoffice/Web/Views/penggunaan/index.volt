            ...
            <div class="modal fade" id="add-data">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form class="form-horizontal" action="/admin/tambah-penggunaan" method="post" enctype="multipart/form-data" role="form">
                        ...
                        <div class="modal fade" id="edit-data{{guna['id']}}">
                            <div class="modal-dialog modal-lg">
                                ...
                                <span aria-hidden="true">&times;</span>
                                    ...
                                    <form class="form-horizontal" action="/admin/edit-penggunaan/{{guna['id']}}" method="post" enctype="multipart/form-data" role="form">
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <div class="col-lg">
