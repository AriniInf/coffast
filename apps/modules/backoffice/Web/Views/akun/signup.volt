                ...
                <div class="signin-content ">
                    ...
                    <div class="signin-form ">
                        ...
                        <form method="POST" class="data-form" action="/register">
                            ...
                            <div class="form-group ">
                                <label for="noiden "><i class="zmdi zmdi-face material-icons-name "></i></label>

                                <input type="text" name="noiden" id="noiden" placeholder="No Identitas" required/>
                            </div>
                            ...
                            <div class="form-group ">
                                <label for="notelp"><i class="zmdi zmdi-collection-text"></i></label>
