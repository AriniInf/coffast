            ...
            <div class="modal fade" id="add-data">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form class="form-horizontal" action="/admin/tambah-pegawai" method="post" enctype="multipart/form-data" role="form">
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ad['notelp']}}</td>
                    <td>
                        <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#edit-data{{ad['id']}}"><i class="fas fa-pencil-alt">
                        </i> Edit</button>
