        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{kar.note}}</td>
                    <td>
                        <form action="/admin/verifikasi-pegawai" method="post">
                        ...
                        <a type="button" class="btn btn-danger btn-md" href='/admin/delete-pegawai/{{kar.id}}' onclick="return deleteDialog();"><i class="fas fa-trash">
                        </i> Hapus</a>
                    </td>
                </tr>
                {% endfor %}
