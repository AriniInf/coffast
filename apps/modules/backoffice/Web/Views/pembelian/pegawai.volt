            ...
            <div class="modal fade" id="add-data">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form class="form-horizontal" action="/pegawai/add-pembelian" method="post" enctype="multipart/form-data" role="form">
                        ...
                        <div class="modal fade" id="edit-data{{beli['id']}}">
                            <div class="modal-dialog modal-lg">
                                ...
                                <span aria-hidden="true">&times;</span>
                                    ...
                                    <form class="form-horizontal" action="/pegawai/edit-pembelian/{{beli['id']}}" method="post" enctype="multipart/form-data" role="form">
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <div class="col-lg">
